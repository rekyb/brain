...
| **Testing** | Requires mocking components or mounting wrapper containers. | Custom hooks can be tested in isolation using `renderHook` from `@testing-library/react-native`. |
...
- Prev: [2.3 Dynamic Routing and Params](2.3%20Dynamic%20Routing%20and%20Params.md)
- Next: [3.2 Server State with TanStack Query](3.2%20Server%20State%20with%20TanStack%20Query.md)
