...
stateDiagram-v2
    ...
    Offline --> Idle : Network Restored & Queue Empty
    ...
    RetryDelay --> Offline : Network Lost
...
## 🏗️ Capstone step: SQLite, Drizzle, MMKV, and Offline Mutation Queue
...
- Prev: [4.2 Relational Storage with SQLite and Drizzle](4.2%20Relational%20Storage%20with%20SQLite%20and%20Drizzle.md)
- Next: [5.1 System Permissions and App Lifecycle](5.1%20System%20Permissions%20and%20App%20Lifecycle.md)
