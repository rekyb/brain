...
Agents (like Gemini / Antigravity) read this vault as **background context** while working in separate code repos. Use it to orient: architecture, conventions, design knowledge, and per-project understanding.
